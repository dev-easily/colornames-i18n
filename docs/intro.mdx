...
## Add a locale
If you click on the first column of [the table](https://dev-easily.github.io/colornames-i18n/), Color Names i18n will take you to `deepl.com` and translate the name from english to
